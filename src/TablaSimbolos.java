...
public class TablaSimbolos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaSimb = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        tablaSimb.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Identificador", "Tipo de dato", "Valor", "Fila declaración"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tablaSimb);
    ...
    private void mostrarElemTabla(Hashtable tablaSimbolos){
        modelo = (DefaultTableModel)tablaSimb.getModel();
        ...
        Enumeration keys=tablaSimbolos.keys();
        while (elem.hasMoreElements()){//Verificamos que la tabla contenga más simbolos
            ...
            Object []arr={keys.nextElement(),sim.tipo,sim.valor,sim.fila};
            modelo.addRow(arr);
        }
    }
    /**
    ...
    private javax.swing.JTable tablaSimb;
